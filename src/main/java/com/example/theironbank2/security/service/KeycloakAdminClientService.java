package com.example.theironbank2.security.service;
...
public class KeycloakAdminClientService {
    ...
    public KeycloakAdminClientService(AccountHolderService accountHolderService, KeycloakProvider keycloakProvider) {
...
//            TODO you may add you logic to store and connect the keycloak user to the local user here
            ...
            accountHolderDTO.setKeycloakId(createdUser.getId());
            accountHolderDTO.setName(createdUser.getFirstName()+" "+createdUser.getLastName());
            var storedAccountHolder = accountHolderService.create(accountHolderDTO);
            log.info(storedAccountHolder.toString());
        }
        return response;
    }
